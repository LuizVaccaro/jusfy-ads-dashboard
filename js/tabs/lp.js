...
function renderLPCheckout(rows0, tableId) {
  ...
  <div class="card">
    ...
    <p style="font-size:12px;color:#8b949e;margin-bottom:12px">
      Páginas <code style="color:#1D9E75">app.jusfy.com.br/register*</code> usadas como landing page de checkout (link direto de campanha para cadastro). Variantes com <code style="color:#1D9E75">CAA</code> ou <code style="color:#1D9E75">OAB</code> no caminho são agrupadas em uma única linha.
    </p>
    <div class="table-wrap"><table>
      <thead><tr>
        <th>#</th>${sortTh(tableId,'Landing Page','landing_page','asc','')}
