...
async function tabSync() {
  ...
  <div class="card">
    ...
    <p style="font-size:13px;color:#212121BF;margin-bottom:14px">
      Sincronize um dia específico ou um intervalo de datas para carregar histórico.
      Para backfill completo (jan/2025 → hoje), use Start: <code style="color:#02A378">2025-01-01</code> e End: data de ontem.
    </p>
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap">
      ...
      <button class="sync-btn" style="border-color:#02A37844;background:#02A37811;color:#02A378" onclick="triggerAll()">⚡ Sync Todos</button>
    </div>
    <div style="margin-top:16px;padding-top:16px;border-top:1px solid #E7E8EC">
      <div style="font-size:12px;font-weight:600;color:#212121;margin-bottom:8px">🎂 Criativos — Aniversário</div>
      <div style="display:flex;gap:8px;flex-wrap:wrap">
    ...
    <div id="syncLog" style="margin-top:14px;font-size:12px;color:#212121BF;font-family:monospace;max-height:200px;overflow-y:auto;background:#FAFAFA;border:1px solid #E7E8EC;border-radius:6px;padding:10px;display:none"></div>
  </div>`;
